    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-white">
      <nav className="mx-auto flex max-w-5xl items-center justify-between p-4 sm:p-6">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-slate-900">StockSync</span>
        </div>
        <a
      ...
      <header className="mx-auto max-w-3xl px-4 pb-12 pt-8 text-center sm:pb-20 sm:pt-16">
        <p className="inline-flex items-center gap-1.5 rounded-full bg-indigo-100 px-3 py-1 text-xs font-semibold text-indigo-700">
      ...
      <section id="how-it-works" className="mx-auto max-w-4xl px-4 py-12">
        <h2 className="text-center text-sm font-semibold uppercase tracking-wide text-indigo-600">How it works</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {FEATURES.map((feature) => (
            <div key={feature.title} className="rounded-xl border border-slate-200 bg-white p-4">
              ...
              <p className="mt-1 text-xs text-slate-600">{feature.body}</p>
            </div>
          ))}
        </div>
      </section>
